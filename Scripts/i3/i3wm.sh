...
echo $'\n'
mkdir ~/.config/i3/
cp -r $absolutepath2'Scripts/i3/config' $user'.config/i3/config'
...
cp -r $absolutepath2'Scripts/i3/polybar-config' $user'.config/polybar/config'
...
echo $'\n'
mkdir ~/.config/rofi/
cp -r $absolutepath2'Scripts/rofi/config.rasi' $user'.config/rofi/config.rasi'
